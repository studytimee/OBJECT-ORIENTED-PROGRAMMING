...
public class FMS implements IFMS 
{
  ...
  public boolean open(String filename)
  {
    ...
    try
    {
    	//File source = new File(filename); //Project Base Diretory
      //File source = new File(dir+filename);
      //File source = new File(FileManager.dir_userAcc+filename+".ser"); // File saved in custom created directory.
    	File source = new File(FileManager.dir_userAcc+filename); // File saved in custom created directory.
  ...
  public boolean save(String filename)
  {
    ...
    try
    {
        ...
        File destination = new File(FileManager.dir_userAcc+filename);
